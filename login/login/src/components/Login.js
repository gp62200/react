  ...
  async function submit(e) {
    ...
    try {
      await axios
        ...
        .then((res) => {
          if ((res.data == "exist")) {
            history("/payroll", { state: { id: email } });
          }
          else if ((res.data == "notexist")) {
            alert("user not signup yet");
          }
        });
    } catch (e) {
      alert("wrong details");
            ...
            <div className='rightDiv'>
              ...
              <form className="rightInnerDiv" >
                ...
                <div>
                  ...
                  <input type="password" name="pass" id="pass" value={password} onChange={(e) => setPassword(e.target.value)} required></input>

                </div><br />
                <button type='submit' disabled={!validateForm()} onClick={submit}>Login</button>
                <br />
                <p> OR</p>
